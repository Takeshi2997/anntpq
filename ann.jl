...
function Network()
    ...
    layer4 = Dense(Const.layer[4], Const.layer[5], func)
...
function init()
    ...
    W4 = randn(Float32, Const.layer[5], Const.layer[4]) * sqrt(1.0f0 / Const.layer[4])
    b1 = zeros(Float32, Const.layer[2])
    b2 = zeros(Float32, Const.layer[3])
    b3 = zeros(Float32, Const.layer[4])
    b4 = zeros(Float32, Const.layer[5])
    p  = params([W1, b1], [W2, b2], [W3, b3], [W4, b4])
